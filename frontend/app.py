    ...
    if "token" not in st.session_state:
            ...
            if users:
                ...
                if selected_user:
                    with st.sidebar.expander("🗑️ Delete User"):
                        ...
                        if st.button("Delete User", type="primary", key="del_btn"):
        ...
        if group_mode:
            ...
            if selected_user:
                ...
                # c4 will be populated after unrealized P&L is computed — store a placeholder
                _unreal_metric_placeholder = c4

                st.divider()
                # Update unrealized metric if computed
                ...
                with tab1:
                    ...
                    with st.expander("📈 Equity Upload", expanded=True):
                        ...
                        if st.button("▶ Process Equity Files", type="primary", disabled=(not uploaded_files), key="eq_process_main"):
                ...
                with tab2:
                    ...
                    if st.button("🔁 Re-run Auto Populate (with ScripMaster DB)", key="sm_auto_pop"):
